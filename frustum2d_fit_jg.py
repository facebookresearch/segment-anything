...
def fit_frustum(points, img_shape, ferrule_box, restarts=4, jitter=0.10, live_plot=True):
    h, w = img_shape[:2]
...
if __name__ == "__main__":
    ...
    annotations = load_yolo_annotations("test_data/Nickey_02.txt")
    ...
    result = fit_frustum(points, img.shape, ferrule_box, live_plot=True)
    params = result['params']
